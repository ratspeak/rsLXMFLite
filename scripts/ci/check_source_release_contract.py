#!/usr/bin/env python3
"""Validate rsLXMFLite's public source and dormant-release invariants."""
...
REPOSITORY = "https://github.com/ratspeak/rsLXMFLite"
...
def check_metadata() -> None:
    ...
    dependencies = {item["name"]: item for item in package["dependencies"]}
    if dependencies.get("rns-lite-core", {}).get("req") != "^0.1.0":
        problems.append("rns-lite-core dependency must carry the 0.1.0 compatibility requirement")
    if problems:
        fail("; ".join(problems))
...
def main() -> None:
    ...
    check_metadata()
    refs = read_refs("TRUSTED_REF") | read_refs("RNS_LITE_REF")
    ...
    print(f"source-release contract passed for rsLXMFLite {EXPECTED_VERSION}")
